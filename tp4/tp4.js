...
// Estas funciones "orquestan" el pipeline usando las piezas de ejercicio4.js
...
function render() {
  ...
  // 7. Actualizo la interfaz y la mini-vista del z-buffer
  updateSliderValues();
  if (typeof drawZBufferView === 'function') {
    drawZBufferView(depth, W, H);
  }
}
...
document.addEventListener('DOMContentLoaded', initializeTP4);